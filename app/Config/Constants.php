...
defined('BASEPATH') || define('BASEPATH',$root.'public/');
defined('IMAGEPATH') || define('IMAGEPATH',$root.'public/');

//defined('ether_api')	|| define('ether_api' ,$protocol.$_SERVER['REMOTE_ADDR'].':8181');

/*defined('ether_api')	|| define('ether_api' ,'http://164.68.100.9:8484');*/
