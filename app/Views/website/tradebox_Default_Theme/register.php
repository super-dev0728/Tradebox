        ...
        <div class="user-login form-design">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="email" name="remail" placeholder="example@mail.com"
            ...
            <div class="form-row password_valid">
                <div class="form-group col-md-6">
                    ...
                    <input type="password" class="form-control" id="pass" name="rpass" placeholder="Password"
                        onkeyup="strongPassword()">
                </div>
                <div class="form-group col-md-6">
                    <label for="r_pass"><?php echo display('confirm_password') ?> <span
                            class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="r_pass" name="rr_pass" placeholder="Password"
                        onkeyup="rePassword()">
                </div>
                <div id="message">
            ...
            <div class="d-flex justify-content-between mb-3">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="accept_terms" name="raccept_terms"
                        value="ptConfirm">
                    <label class="custom-control-label" for="accept_terms">
                        <?php echo display('register_save_password'); ?></label>
                </div>
            </div>
