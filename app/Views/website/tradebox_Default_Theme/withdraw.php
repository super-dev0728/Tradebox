<div class="col-lg-4 offset-lg-4  form-content login mt-4 mb-4">
    <div class="mb-4 form-design">
        ...
        <div class="form-group">
            <label for="withdraw_type" class="">Withdraw(Crypto/Dollar) <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="amount" step="any" min="0" type="number" id="amount" onkeyup="Fee()"
                autocomplete="off" required>
            <span id="fee" class="form-text text-success"></span>
        </div>
        <div class="form-group">
            <label for="payment_method" class=""><?php echo display('payment_method');?> <span
                    class="text-danger">*</span></label>
            <select class="form-control basic-single" name="method" id="payment_method"
                onchange="WalletId(this.value); Fee()">
        ...
        <div class="form-group row">
            <label for="p_name" class="col-sm-5"><?php echo display('otp_send_to')?>
